...
Route::get('/data_karyawan', [App\Http\Controllers\KaryawanController::class, 'index'])->middleware('auth');
Route::get('/tambah_karyawan', [App\Http\Controllers\KaryawanController::class, 'create'])->middleware('auth');
Route::post('/tambah_karyawan', [App\Http\Controllers\KaryawanController::class, 'store'])->middleware('auth');
Route::get('/hapus_karyawan/{karyawan}', [App\Http\Controllers\KaryawanController::class, 'destroy'])->middleware('auth');
Route::get('/ubah_karyawan/{karywan}', [App\Http\Controllers\KaryawanController::class, 'edit'])->middleware('auth');
Route::post('/ubah_karyawan', [App\Http\Controllers\KaryawanController::class, 'update'])->middleware('auth');
Route::get('/detail_karyawan/{karyawan}', [App\Http\Controllers\KaryawanController::class, 'detail'])->middleware('auth');
Route::get('/cetak_kartu', [App\Http\Controllers\KaryawanController::class, 'showtwo'])->middleware('auth');
